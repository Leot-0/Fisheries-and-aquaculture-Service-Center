		...
		<template v-if="showFlag">
			...
			<div :style='{"border":"0px solid #bababa","padding":"0","margin":"0 0 0 0","borderRadius":"2px","background":"rgba(255,255,255,1)","width":"calc(100% - 0px)","float":"right"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true' prop="zhengshu" label="证书">
						<template slot-scope="scope">
							<el-button v-if="scope.row.zhengshu" type="text" size="small" @click="download(scope.row.zhengshu)">下载</el-button>
                            <span v-else >无</span>
						</template>
					</el-table-column>
