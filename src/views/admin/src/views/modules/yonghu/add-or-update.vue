...
<!--				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="等级" prop="dengji">-->
...
<!--					</el-select>-->
<!--				</el-form-item>-->
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="input" label="等级" prop="dengji">

          <el-input v-if="ruleForm.jingyan<100" value="普通渔民" placeholder="等级" readonly></el-input>
          <el-input v-else-if="ruleForm.jingyan<500" value="捕鱼达人" placeholder="等级" readonly></el-input>
          <el-input v-else value="民间大神" placeholder="等级" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="经验" prop="jingyan">
					<el-input v-model.number="ruleForm.jingyan" placeholder="经验" clearable  :readonly="ro.jingyan"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 36px 0","color":"inherit","borderRadius":"0px","width":"100%","fontSize":"inherit"}' v-else class="input" label="经验" prop="jingyan">
					<el-input v-model="ruleForm.jingyan" placeholder="经验" readonly></el-input>
				</el-form-item>
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				this.ruleForm.dengji = '普通渔民'; 				this.ruleForm.jingyan = Number('0'); 			}
			// 获取用户信息
			this.$http({
            ...
            this.dengjiOptions = "普通渔民,捕鱼达人,民间大神".split(',')
