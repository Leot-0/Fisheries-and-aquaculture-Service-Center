...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="等级" prop="dengji">
            <el-select v-model="ruleForm.dengji" placeholder="请选择等级" :disabled="true  ||ro.dengji" >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="经验" prop="jingyan">
            <el-input v-model.number="ruleForm.jingyan" 
                placeholder="经验" clearable :disabled="true  ||ro.jingyan"></el-input>
          </el-form-item>
