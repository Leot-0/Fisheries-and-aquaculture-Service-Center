...
<div class="center-preview" :style='{"padding":"0 7%","margin":"20px auto 40px","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","position":"relative","justifyContent":"space-between"}'>
	...
	<div class="info" :style='{"padding":"10px","boxShadow":"0 0px 0px rgba(0, 0, 0, 0.3)","margin":"20px 3% 0 0","borderColor":"#eee","borderRadius":"0px","background":"#ffffff","borderWidth":"4px 2px 1px","width":"25%","borderStyle":"solid","height":"auto"}'>
		...
		<div :style='{"borderColor":"#efefef","margin":"0 auto","borderWidth":"0 0 1px 0","width":"90%","fontSize":0,"borderStyle":"solid","height":"auto"}' v-if="userTableName=='zhuanyerenyuan'">
			<el-image :style='{"margin":"10px auto","borderColor":"#efefef","objectFit":"cover","borderRadius":"100%","borderWidth":"0 0 1px 0","display":"block","width":"80px","borderStyle":"solid","height":"80px"}' :src="sessionForm.touxiang?baseUrl + sessionForm.touxiang:require('@/assets/avator.png')" fit="cover"></el-image>
		</div>
		...
		<div :style='{"padding":"0 20px","borderColor":"#efefef","margin":"0 auto","borderWidth":"0 0 1px 0","display":"flex","width":"90%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='yonghu'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"color":"#333","padding":"0 5px","fontSize":"14px"}'></span>
			<div :style='{"color":"#333","fontSize":"14px"}'>手机号</div>
			<div :style='{"fontSize":"14px","color":"#333","textAlign":"right","flex":1}'>{{sessionForm.shoujihao}}</div>
		</div>
    <div :style='{"padding":"0 20px","borderColor":"#efefef","margin":"0 auto","borderWidth":"0 0 1px 0","display":"flex","width":"90%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='yonghu'">
      <span class="icon iconfont icon-shouye-zhihui" :style='{"color":"#333","padding":"0 5px","fontSize":"14px"}'></span>
      <div :style='{"color":"#333","fontSize":"14px"}'>获赞数</div>
      <div :style='{"fontSize":"14px","color":"#333","textAlign":"right","flex":1}'>{{sessionForm.jingyan}}</div>
    </div>
    <div :style='{"padding":"0 20px","borderColor":"#efefef","margin":"0 auto","borderWidth":"0 0 1px 0","display":"flex","width":"90%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='yonghu'">
      <span class="icon iconfont icon-shouye-zhihui" :style='{"color":"#333","padding":"0 5px","fontSize":"14px"}'></span>
      <div :style='{"color":"#333","fontSize":"14px"}'>账号状态</div>
      <div v-if="sessionForm.jingyan<100" :style='{"fontSize":"14px","color":"#333","textAlign":"right","flex":1}'>普通渔民</div>
      <div v-else-if="sessionForm.jingyan<500" :style='{"fontSize":"14px","color":"#00c292","textAlign":"right","flex":1}'>捕鱼达人</div>
      <div v-else :style='{"fontSize":"14px","color":"#0e90d2","textAlign":"right","flex":1}'>民间大神</div>
    </div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","margin":"0 auto","borderWidth":"0 0 1px 0","display":"flex","width":"90%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='zhuanyerenyuan'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"color":"#333","padding":"0 5px","fontSize":"14px"}'></span>
			<div :style='{"color":"#333","fontSize":"14px"}'>人员账号</div>
			<div :style='{"fontSize":"14px","color":"#333","textAlign":"right","flex":1}'>{{sessionForm.renyuanzhanghao}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","margin":"0 auto","borderWidth":"0 0 1px 0","display":"flex","width":"90%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='zhuanyerenyuan'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"color":"#333","padding":"0 5px","fontSize":"14px"}'></span>
			<div :style='{"color":"#333","fontSize":"14px"}'>人员姓名</div>
			<div :style='{"fontSize":"14px","color":"#333","textAlign":"right","flex":1}'>{{sessionForm.renyuanxingming}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","margin":"0 auto","borderWidth":"0 0 1px 0","display":"flex","width":"90%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='zhuanyerenyuan'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"color":"#333","padding":"0 5px","fontSize":"14px"}'></span>
			<div :style='{"color":"#333","fontSize":"14px"}'>性别</div>
...
<!--          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='yonghu'" label="等级" prop="dengji">-->
<!--            <el-select v-model="sessionForm.dengji" placeholder="请选择等级" disabled>-->
<!--              <el-option v-for="(item, index) in dynamicProp.dengji" :key="index" :label="item" :value="item"></el-option>-->
<!--            </el-select>-->
<!--          </el-form-item>-->
<!--          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='yonghu'" label="经验" prop="jingyan">-->
<!--            <el-input v-model="sessionForm.jingyan" placeholder="经验" readonly></el-input>-->
<!--          </el-form-item>-->
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='zhuanyerenyuan'" label="人员账号" prop="renyuanzhanghao">
            <el-input v-model="sessionForm.renyuanzhanghao" placeholder="人员账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='zhuanyerenyuan'" label="人员姓名" prop="renyuanxingming">
            <el-input v-model="sessionForm.renyuanxingming" placeholder="人员姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='zhuanyerenyuan'" label="性别" prop="xingbie">
            <el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='zhuanyerenyuan'" label="年龄" prop="nianling">
            <el-input v-model="sessionForm.nianling" placeholder="年龄" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='zhuanyerenyuan'" label="邮箱" prop="youxiang">
            <el-input v-model="sessionForm.youxiang" placeholder="邮箱" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='zhuanyerenyuan'" label="手机号" prop="shoujihao">
            <el-input v-model="sessionForm.shoujihao" placeholder="手机号" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' v-if="userTableName=='zhuanyerenyuan'" label="头像" prop="touxiang">
			<file-upload
			tip="点击上传头像"
			action="file/upload"
			:limit="1"
			:multiple="true"
			:fileUrls="sessionForm.touxiang?sessionForm.touxiang:''"
			@change="zhuanyerenyuantouxiangHandleAvatarSuccess"
			></file-upload>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    created() {
		...
		if ('yonghu' == this.userTableName) {
			this.$set(this.sessionForm, 'jingyan', null);
		}
		if ('yonghu' == this.userTableName) {
			this.$set(this.sessionForm, 'touxiang', null);
		}
		if ('zhuanyerenyuan' == this.userTableName) {
		...
		if ('yonghu' == this.userTableName) {
			this.$set(this.rules, 'jingyan', [{ required: false, validator: this.$validate.isIntNumer, trigger: 'blur' }]);
		}
		if ('zhuanyerenyuan' == this.userTableName&&this.rules['renyuanzhanghao']){
			this.rules['renyuanzhanghao'].push({ required: true, message: '请输入人员账号', trigger: 'blur' })
		}else if('zhuanyerenyuan' == this.userTableName&&!this.rules['renyuanzhanghao']) {
			this.$set(this.rules, 'renyuanzhanghao', [{ required: true, message: '请输入人员账号', trigger: 'blur' }]);
		}
		if ('zhuanyerenyuan' == this.userTableName&&this.rules['mima']){
			this.rules['mima'].push({ required: true, message: '请输入密码', trigger: 'blur' })
		}else if('zhuanyerenyuan' == this.userTableName&&!this.rules['mima']) {
			this.$set(this.rules, 'mima', [{ required: true, message: '请输入密码', trigger: 'blur' }]);
		}
		if ('zhuanyerenyuan' == this.userTableName&&this.rules['renyuanxingming']){
			this.rules['renyuanxingming'].push({ required: true, message: '请输入人员姓名', trigger: 'blur' })
		}else if('zhuanyerenyuan' == this.userTableName&&!this.rules['renyuanxingming']) {
    ...
    methods: {
      init() {
        ...
        if ('yonghu' == this.userTableName) {
          this.dynamicProp.dengji = '普通渔民,捕鱼达人,民间大神'.split(',');
        }
        if ('zhuanyerenyuan' == this.userTableName) {
          this.dynamicProp.xingbie = '男,女'.split(',');
        }
      ...
      onSubmit(formName) {
		...
		if(`zhuanyerenyuan` == this.userTableName && this.sessionForm.touxiang!=null){
			this.sessionForm.touxiang = this.sessionForm.touxiang.replace(new RegExp(this.$config.baseUrl,"g"),"");
		}
      ...
      zhuanyerenyuantouxiangHandleAvatarSuccess(fileUrls) {
        this.sessionForm.touxiang = fileUrls;
      },
