...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="举报人账号" prop="jubaorenzhanghao">
            <el-input v-model="ruleForm.jubaorenzhanghao" 
                placeholder="举报人账号" clearable :disabled=" false  ||ro.jubaorenzhanghao"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="举报人姓名" prop="jubaorenxingming">
            <el-input v-model="ruleForm.jubaorenxingming" 
                placeholder="举报人姓名" clearable :disabled=" false  ||ro.jubaorenxingming"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="举报时间" prop="jubaoshijian">
              <el-date-picker
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="举报内容" prop="jubaoneirong">
            <editor 
